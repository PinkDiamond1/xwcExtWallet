...
var openAnyBitDapp = function (params) {
    ...
    dsBridge.call("AnybitDapp.xwcCall", params, function (s) {
        console.log("AnybitDapp.xwcCall: " + JSON.stringify(s));
...
},{"./Utils":1,"./config":4}],4:[function(require,module,exports){
"use strict";
...
var openExtension = function (params) {
    ...
    window.postMessage({
        "src": "xwcPay",
        "logo": "xwc", //to distinguish from other messages
        "params": params
    }, "*");
};
...
window.addEventListener('message', function (resp) {
    ...
    //console.log("xwcpay: received resp.data: " + JSON.stringify(resp.data));
...
var defaultXwcPayPushApiUrl = "http://wallet.xwc.cash/api";

function submitPayId(options) {
	// push serialNumber to xwcpaypush
	try {
		var xwcPayPushApiUrl = options.callback || defaultXwcPayPushApiUrl;
		var xhr = new XMLHttpRequest();
...
Pay.prototype = {
	...
	submitParamsToWallet: function (params, des, options) {
		...
		if (Utils.isChrome() && !Utils.isAnybitMobile() && options.extension.openExtension) {
			if (Utils.isExtInstalled()) openExtension(params);else {
				...
				if (window.confirm('XwcExtWallet is not installed. Click "ok" to install it.')) {
					var installUrl = "https://chrome.google.com/webstore/detail/xwcextwallet/eboifcnkiocbamnhekeoembpmmcnebii";
	...
	submit: function (currency, to, valueRaw, payload, options) {
		options.serialNumber = Utils.randomCode(32);
		valueRaw = valueRaw || "0";
		// var amount = new BigNumber(valueRaw).times("100000");//10^5 XWC's asset precision = 100000
...
},{"./Utils":1,"./anybitHandler":2,"./appHandler":3,"./config":4,"./extensionHandler":5,"./qrcode":8,"bignumber.js":9}],8:[function(require,module,exports){
"use strict";
...
var createDeaultQRContainer = function (options) {
	...
	textInfo.innerHTML = 'Please use <a href= "https://nano.xwc.io/" target="_blank" >NasNano</a> to scan this QR-Code.';
...
},{"./Utils":1,"qrcode":14}],9:[function(require,module,exports){
...
},{"window-or-global":40}],11:[function(require,module,exports){
'use strict';
...
},{"./core/qrcode":30,"./renderer/canvas":36,"./renderer/svg-tag.js":37,"can-promise":10}],15:[function(require,module,exports){
/**
...
},{"./mode":27}],17:[function(require,module,exports){
function BitBuffer () {
  this.buffer = []
  this.length = 0
}
...
},{"../utils/buffer":39}],19:[function(require,module,exports){
var Buffer = require('../utils/buffer')
var Mode = require('./mode')
...
},{"../utils/buffer":39,"./mode":27}],20:[function(require,module,exports){
...
},{"./error-correction-level":21}],21:[function(require,module,exports){
exports.L = { bit: 1 }
exports.M = { bit: 0 }
exports.Q = { bit: 3 }
exports.H = { bit: 2 }
...
},{"../utils/buffer":39}],25:[function(require,module,exports){
var Mode = require('./mode')
var Utils = require('./utils')
...
},{"./mode":27,"./utils":34}],26:[function(require,module,exports){
/**
...
},{"./regex":32,"./version":35}],28:[function(require,module,exports){
var Mode = require('./mode')
...
},{"../utils/buffer":39,"./galois-field":24}],30:[function(require,module,exports){
var Buffer = require('../utils/buffer')
var Utils = require('./utils')
var ECLevel = require('./error-correction-level')
...
},{"../utils/buffer":39,"./alignment-pattern":15,"./bit-buffer":17,"./bit-matrix":18,"./error-correction-code":20,"./error-correction-level":21,"./finder-pattern":22,"./format-info":23,"./mask-pattern":26,"./mode":27,"./reed-solomon-encoder":31,"./segments":33,"./utils":34,"./version":35,"isarray":13}],31:[function(require,module,exports){
var Buffer = require('../utils/buffer')
...
},{"../utils/buffer":39,"./polynomial":29}],32:[function(require,module,exports){
var numeric = '[0-9]+'
...
},{"./alphanumeric-data":16,"./byte-data":19,"./kanji-data":25,"./mode":27,"./numeric-data":28,"./regex":32,"./utils":34,"dijkstrajs":11}],34:[function(require,module,exports){
var toSJISFunction
var CODEWORDS_COUNT = [
  0, // Not used
...
},{"./error-correction-code":20,"./error-correction-level":21,"./mode":27,"./utils":34,"isarray":13}],36:[function(require,module,exports){
var Utils = require('./utils')
...
},{"isarray":13}],40:[function(require,module,exports){
(function (global){
'use strict'
...
},{}],"xwcpay":[function(require,module,exports){
"use strict";
...
var XwcPay = function (appKey, appSecret) {
	this._pay = new Pay(appKey, appSecret);
};

XwcPay.config = config;
...
var xwcChainConfigCacheInXwcPay = null;
...
XwcPay.prototype = {
	...
	postMessageRequest: function (method, data, callbackRegisterMethod, timeout) {
		...
		return new Promise(function (resolve, reject) {
			...
			if (typeof XwcExtWallet === 'undefined') {
				...
				ended = true;
				reject("XwcExtWallet not installed");
				return;
			}
			if (!XwcExtWallet[callbackRegisterMethod]) {
				console.log("method " + callbackRegisterMethod + " not found");
				reject("method " + callbackRegisterMethod + " not found in XwcExtWallet");
				return;
			}
			XwcExtWallet[callbackRegisterMethod](function (config) {
				if (ended) {
					return;
				}
				ended = true;
	...
	onConnectedWallet: function () {
		...
		function isConnected() {
			return typeof XwcExtWallet !== 'undefined' || Utils.isAnybitMobile();
		}
		return new Promise(function (resolve, reject) {
			if (isConnected()) {
				resolve();
	...
	getConfigWithCache: function () {
		if (xwcChainConfigCacheInXwcPay) {
			return Promise.resolve(xwcChainConfigCacheInXwcPay);
		} else {
	...
	waitTransaction: function (nodeClient, txid, timeout) {
		...
		return new Promise(function (resolve, reject) {
			...
			var intervalFunc = function () {
				...
				nodeClient.getTransactionById(txid).then(function (tx) {
					clearInterval(intervalHandler);
					resolve(tx);
				}).catch(function (err) {});
			};
...
},{"./libs/Utils":1,"./libs/config":4,"./libs/http":6,"./libs/pay":7,"bignumber.js":9,"extend":12}]},{},[]);
